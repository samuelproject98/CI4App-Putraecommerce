...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        $users_default = [
            ...
            'username'         => 'putraecommerce2021',
            'password_hash'    => '$2y$10$LE.CXk5WQI6YCG9V/7n5LOnL3Z28Whs7rlnqbUzLxu6hfv7jsfsMu',
            'active'           => '1',
            'force_pass_reset' => '0',
        ...
        $this->db->table('users')->insert($users_default);
        ...
        $this->db->table('auth_groups')->insertBatch($group_default);
